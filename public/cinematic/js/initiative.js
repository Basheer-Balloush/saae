(() => {
  ...
  const translations = {
    ...
    heroEyebrow: "مبادرة وطنية لمحو الأمية في الذكاء الاصطناعي", ghostMillion: "المليون", heroName: "مبادرة المليون مستخدم للذكاء الاصطناعي", oneMillion: "مليون", heroTitleRest: "مستخدم ذكاء اصطناعي سوري.",
    ...
    progressKicker: "زخم نحو المليون", activatedLabel: "تم تفعيلها", millionGoal: "الهدف 1,000,000", seatsMotion: "مقعداً قيد التفعيل", waitlist: "قائمة الانتظار", sponsoredSeats: "مقاعد ممولة", goalRemaining: "المتبقي إلى الهدف", shareOfDial: "من الإجمالي الحالي", shareOfGoal: "من الهدف",
