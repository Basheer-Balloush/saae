...
export const lmsT: Record<Lang, {
  ...
  ar: {
    ...
    intermediate: "متوسط",
    advanced: "متقدم",
    noCourses: "ما في دورات حالياً",
    byInstructor: "بواسطة",
    students: "طالب",
    enroll: "سجّل في الدورة",
    ...
    lessons: "الدروس",
    myCourses: "دوراتي",
    noEnrollments: "ما سجّلت بأي دورة بعد",
    progress: "التقدّم",
    ...
    enrollmentSuccess: "تم التسجيل بالدورة بنجاح",
    comingSoon: "قريباً",
