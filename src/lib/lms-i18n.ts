...
export const lmsT: Record<Lang, {
  ...
  ar: {
    ...
    courseEnded: "دورة منتهية",
    courseEndedShort: "منتهية",
    courseEndedSr: "انتهت هذه الدورة",
  ...
  en: {
    ...
    courseEndedShort: "Ended",
    courseEndedSr: "This course has ended",
