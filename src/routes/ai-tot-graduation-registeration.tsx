...
const T = {
  ar: {
    ...
    closedBody: "نعتذر، تم إغلاق باب التسجيل لهذه الفعالية. شكراً لاهتمامكم.",
    ok: "حسناً",
...
const AGENDA_AR: { time: string; item: string; speaker?: string }[] = [
  ...
  { time: "10:26 - 10:18", item: "كلمة راعي الندوة", speaker: "معالي وزير الاتصالات وتقانة المعلومات" },
  { time: "10:34 - 10:26", item: "كلمة مدير التدريب", speaker: "المهندس وليد حلاوة — مدير التدريب في الجمعية" },
  { time: "10:46 - 10:34", item: "كلمات خريجي دورة TOT", speaker: "خريجي دورة ال TOT" },
  { time: "10:53 - 10:46", item: "قصة خريج من واقع الدورة", speaker: "المهندس محمد قربي" },
  ...
  { time: "12:18 - 11:33", item: "(جلسة حوارية) مستقبل التدريب في ظل علوم الذكاء الاصطناعي", speaker: "\n" },
  { time: "12:25 - 12:18", item: "عرض كلمات ممثلي الجمعية في العالم", speaker: "ممثلي الجمعية حول العالم" },
  { time: "12:40 - 12:25", item: "تكريم الخريجين", speaker: "\n" },
