...
اسأل الأسئلة الستة التالية **واحداً تلو الآخر**، سؤالاً واحداً في كل رسالة. اذكر التقدّم بصيغة «سؤال 2 من 6» (الأسئلة 7 و8 إضافية ولا تُحتسب). لا تسأل أكثر من سؤال في الرسالة الواحدة، ولا تكرّر سؤالاً أجاب عنه ضمناً، وانتقل مباشرةً إلى السؤال التالي بعد كل إجابة دون تعليق طويل.
