...
export const Route = createFileRoute("/contact")({
  head: () => ({
    ...
    links: [
      { rel: "stylesheet", href: "/cinematic/css/contact.css?v=contact-responsive-10" },
...
function Page() {
  ...
  return (
    <>
      <CinematicPage html={pageHtml} scripts={SCRIPTS} bodyClass="page-contact" />
      <DesktopMotionFooter targetSelector="#contact-motion-footer-root" />
    </>
  );
}
