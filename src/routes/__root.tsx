...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "SAAE" },
      { name: "description", content: "الجمعية السورية للذكاء الاصطناعي وريادة الأعمال هي جمعية تهدف إلى نشر ثقافة الذكاء الاصطناعي وريادة الأعمال في المجتمع السوري، من خلال بناء مجتمعات تقنية متخصصة" },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "SAAE" },
      { property: "og:description", content: "الجمعية السورية للذكاء الاصطناعي وريادة الأعمال هي جمعية تهدف إلى نشر ثقافة الذكاء الاصطناعي وريادة الأعمال في المجتمع السوري، من خلال بناء مجتمعات تقنية متخصصة" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "SAAE" },
      { name: "twitter:description", content: "الجمعية السورية للذكاء الاصطناعي وريادة الأعمال هي جمعية تهدف إلى نشر ثقافة الذكاء الاصطناعي وريادة الأعمال في المجتمع السوري، من خلال بناء مجتمعات تقنية متخصصة" },
