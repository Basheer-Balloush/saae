...
type Locale = "ar" | "en";
type GuideContext = "hero" | "news" | "partners" | "mission" | "faq";
...
const SECTION_COPY: Record<Exclude<GuideContext, "hero">, Record<Locale, GuideCopy>> = {
  news: NEWS_COPY,
  partners: {
    ar: {
      ...SHARED.ar,
...
const SECTION_COMIC_IMAGES: Record<Exclude<GuideContext, "hero">, string> = {
