          ...
          <div className="mission-reel" id="mission-reel">
            <div className="mission-sticky">
              <div className="mission-words" aria-hidden="true">
                <span data-step="01" data-caption="Learn it. Teach it. Pass it on.">TRAIN</span>
                <span data-step="02" data-caption="Test it. Measure it. Make it useful.">APPLY</span>
                <span data-step="03" data-caption="Launch it. Grow it. Make it last.">BUILD</span>
              </div>
              <div className="mission-grid">
            <article className="mission-item reveal">
              <span className="mission-index">01 / TRAIN</span>
            ...
            <article className="mission-item reveal">
              <span className="mission-index">02 / APPLY</span>
            ...
            <article className="mission-item reveal">
              <span className="mission-index">03 / BUILD</span>
